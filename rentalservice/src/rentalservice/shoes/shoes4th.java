...
public class shoes4th extends JPanel  implements ActionListener  {
	...
	ImageIcon[] img = new ImageIcon[] { new ImageIcon("./img/ParaNoise/paranoise.png"), new ImageIcon("./img/ParaNoise/paranoise3.png"),
	         new ImageIcon("./img/ParaNoise/paranoise4.png"), new ImageIcon("./img/ParaNoise/paranoise5.png")};
	// 이미지 배열 선언
	 String prodname =  "PARANOISE";
	   String prodprice = "600000";


	String[] option = { "PARANOISE" };
	...
	public shoes4th() {
		...
		textLbl.setText("<html><br><h1>PARA-NOISE<h1><html>"
	            + "<html><h3>파라노이즈는 유명 연예인 권지용님의"
	            + "<br>작품인 신발으로 유명한 제품이다."
	            + "<br>특히 스우시가 검노 컬러는 판매용이아닌"
	            + "<br>권지용님의 지인들을 위해 생산된"
	            + "<br>패밀리 에디션입니다."
	            + "<br>한정판중에 한정판이다.</h3>"
