...
public class shoes1st extends JPanel implements ActionListener {
	 int j =1;
   int i = 1;
   String shoesSize;
   ...
   ImageIcon logo = new ImageIcon("./img/1.png");
   ImageIcon[] img = new ImageIcon[] { new ImageIcon("./img/back/back1.jpg"), new ImageIcon("./img/back/back2.jpg"),
         new ImageIcon("./img/back/back3.jpg"), new ImageIcon("./img/back/back4.jpg") }; // 이미지 배열 선언
   String prodname =  "BACK TO THE FUTURE";
   String prodprice = "200000";

   String[] option = { "BACK TO THE FUTURE" };
   String[] size = { "220", "230", "240", "250", "260", "270", "280", "290" }; // 셀렉트 박스 선언
   ...
   public shoes1st() {
      ...
      textLbl.setText("<html><br><h1>BACK TO THE FUTURE<h1><html>" + "<html><h3>영화 \"백투더퓨처\" 에서  나온 신발을 본떠 나이키에서 출시한 신발이며"
            + "<br>영화에서 나온 것과 같은 자동 끈 기능을 탑재한 운동화입니다.<br><br></h3>" + "<br> <h2>렌탈을 희망하신다면 옵션을 선택해주세요</h2><html>");
      Panel21.add(textLbl);
      ...
      @SuppressWarnings({ "unchecked", "rawtypes" })
      JComboBox strCombo = new JComboBox(option);
      Panel22.add(strCombo);   // 상품명 체크박스
