...
public class shoes3rd extends JPanel  implements ActionListener  {
	 int j =1;
	int i = 1;
	...
	ImageIcon[] img = new ImageIcon[] { new ImageIcon("./img/maesyard/maesyard1.png"),
			new ImageIcon("./img/maesyard/maesyard2.png"), new ImageIcon("./img/maesyard/maesyard3.png"),
			new ImageIcon("./img/maesyard/maesyard4.png") };
	// 이미지 배열 선언
	String prodname =  "MASEYARD";
	   String prodprice = "500000";

	String[] option = { "MASEYARD" };
	...
	public shoes3rd() {
		...
		textLbl.setText("<html><br><h1>MASEYARD<h1><html>" + "<html><h3>미국 뉴욕에서 활동하고 있는 아티스트 톰삭스와의 콜라보로 탄생한 신발입니다."
				+ "<br>첨단 우주복 소재를 차용하여 제작하였으며 전 세계 300족 미만 생산으로 <br>높은 희소성을 보유하고 있습니다.<br><br></h3>"
