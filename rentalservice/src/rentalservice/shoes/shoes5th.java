...
public class shoes5th extends JPanel  implements ActionListener  {
	...
	ImageIcon[] img = new ImageIcon[] { new ImageIcon("./img/Stranglove/Stranglove1.jpg"),
			new ImageIcon("./img/Stranglove/Stranglove2.jpg"), new ImageIcon("./img/Stranglove/Stranglove3.jpg"),
			new ImageIcon("./img/Stranglove/Stranglove4.jpg"), new ImageIcon("./img/Stranglove/Stranglove5.jpg"),
			new ImageIcon("./img/Stranglove/Stranglove6.jpg") };

	  String prodname = "STRANGE LOVE";
	   String prodprice = "760000";
	// 이미지 배열 선언
	String[] option = { "STRANGE LOVE" };
	...
	public shoes5th() {
		...
		textLbl.setText("<html><br><h1>STRANG LOVE<h1><html>"
	            + "<html><h3>나이키 SB 덩크와 스케이트 보드 브랜드인"
	            + "<br>STRANGELOVE SKATEBOARDS 콜라보 모델!"
	            + "<br>벨벳 스웨이드 소재와 해골 모양의 "
	            + "<br>자수 디테일이 매력적인 모델</h3>"
