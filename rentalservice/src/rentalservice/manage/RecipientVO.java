...
public class RecipientVO {
	...
	public RecipientVO() {	}
	public RecipientVO(String orderuser_name, String orderuser_ename,
			String orderuser_zipcode, String orderuser_address, String orderuser_birth,
	...
	public RecipientVO(String orderuser_name) {
		this.orderuser_name = orderuser_name;
	}
